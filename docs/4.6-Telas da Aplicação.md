...
Na tela de Lista dos Pedidos de Compra vão constar a data que foi realizado o pedido, seu status, seu número, código do usuário que realizou e seu respectivo nome. Assim é possível visualizar em tempo real a situação de cada compra.

# Pedidos de Venda
## Novo Pedido de Venda (Botão)
![Pedidos](images/fluxo-tela/Pedidos-Venda-1.png)  
Tela onde o usuário segue o fluxo para registrar um novo pedido de venda que foi confirmado entre a distribuidora e o cliente.
...
Assim como na Lista dos Pedidos de Compra, com intuito semelhante temos a Lista dos Pedidos de Venda, para saber seu status, data, número e a identificação do usuário que a realizou.
